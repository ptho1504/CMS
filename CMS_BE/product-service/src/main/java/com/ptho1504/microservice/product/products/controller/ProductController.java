...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<ProductRepsonse>> createProduct(
        ...
        return ResponseEntity
                .ok(ResponseUtil.success(repsonse, "Create Product Successfully", request.getRequestURI()));
    }
    ...
    public ResponseEntity<ApiResponse<PageResult<ProductRepsonse>>> findAll(
        ...
        return ResponseEntity
                .ok(ResponseUtil.success(repsonse, "findAll Product Successfully", request.getRequestURI()));
    }
    ...
    public ResponseEntity<ApiResponse<ProductRepsonse>> updateProduct(
        ...
        return ResponseEntity
                .ok(ResponseUtil.success(repsonse, "updateProduct Successfully", request.getRequestURI()));
    }
}
